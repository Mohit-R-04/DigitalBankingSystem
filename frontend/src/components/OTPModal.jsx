      ...
      <div className="bg-white rounded-2xl p-8 w-full max-w-md mx-4 shadow-xl">
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            className="w-full text-center text-2xl tracking-[0.5em] font-mono px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent mb-4"
          />
