    ...
    return (
      <div className="max-w-lg mx-auto">
        <div className="card p-6 sm:p-8 text-center">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-2">Account Created!</h2>
          <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 mb-6">
            <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 mb-1">Account Number</p>
            <p className="text-xl sm:text-2xl font-mono font-bold text-indigo-600">{created.accountNumber}</p>
          </div>
          <div className="grid grid-cols-2 gap-3 text-sm mb-6">
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3"><p className="text-gray-500 dark:text-gray-400 dark:text-gray-500">Holder</p><p className="font-medium">{created.accountHolderName}</p></div>
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3"><p className="text-gray-500 dark:text-gray-400 dark:text-gray-500">Balance</p><p className="font-medium">₹{Number(created.balance).toLocaleString('en-IN')}</p></div>
          </div>
    ...
    <div className="max-w-lg mx-auto">
      <div className="card p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-1">Account Holder Name</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-1">Phone</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-1">Account Type</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-600 mb-1">Initial Deposit (₹)</label>
