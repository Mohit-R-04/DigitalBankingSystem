    ...
    return (
      <div className="max-w-md mx-auto">
        <div className="card p-6 sm:p-8 text-center">
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-2">Money Added!</h2>
          <p className="text-gray-600 dark:text-gray-300 dark:text-gray-600 mb-6 text-sm sm:text-base">₹{Number(form.amount).toLocaleString('en-IN')} credited to <span className="font-mono">{form.accountNumber}</span></p>
